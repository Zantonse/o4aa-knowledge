...
export const content: SectionContent = {
  ...
  cards: [
    ...
    },
    {
      ...
      paragraphs: [
        'The discovery questions that open the audit conversation are designed to surface gaps that customers often have not fully articulated. "How would you audit what an AI agent did on behalf of a specific user?" is the starting point — most organizations discover in answering this question that they rely on application logs they do not fully control, or that their current architecture produces no per-call audit record at all. "Who is accountable when an AI agent makes a mistake — and how do you prove what happened?" adds the accountability dimension, which resonates strongly with legal, compliance, and security leadership. "Does your current auth model produce per-call audit records for agent actions?" makes the gap concrete and quantifiable.',
