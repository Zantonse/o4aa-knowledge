  ...
  cards: [
    ...
    },
    {
      ...
      paragraphs: [
        ...
        'For SE conversations: the BFF pattern is the answer to "how do we get Okta auth into Claude Code / Cursor / Copilot without those vendors integrating with Okta?" The Adapter handles it transparently — no changes required from the AI agent vendor.',
      ],
    },
    {
