...
const cards = [
  {
    ...
    paragraphs: [
      ...
      'TT Objection response: "Service principal tokens tell the API who the agent is but not who the user is. Entra OBO requires user-initiated flow and breaks for autonomous agents. Okta OBO Token Exchange works for both human-initiated and autonomous patterns."',
    ],
  },
  {
    heading: 'AWS IAM',
    paragraphs: [
      ...
      'TT Objection response: "IAM roles authenticate your agent to AWS services. They cannot tell your non-AWS APIs which user authorized the action or enforce per-user data access. Okta handles the human-delegated identity layer that IAM was never designed for."',
    ],
  },
  {
  ...
  },
  {
    ...
    paragraphs: [
      ...
      'TT Objection response: "CyberArk solves where to store the agent\'s API keys. Okta solves the user delegation layer — which user authorized the agent, what scope, and the audit trail."',
      ...
      'TT Objection response: "PingFederate can do token exchange, but you\'re looking at significant integration work to wire it with PingAuthorize into a coherent agent identity layer. Okta O4AA is purpose-built — OBO, FGA, and XAA are designed to work as a unit."',
    ],
  },
];
